...
from model import (EE_GAT_ours,EE_GAT_only)
...
def parse_args():
    ...
    parser.add_argument('--our_corpus_w2v', type=bool, default=False,
                        help='use the own specific corpus')
    ...
    parser.add_argument('--gat', type=bool,default=False,
                        help='GAT')
    parser.add_argument('--gat_our', type=bool, default=True,
                        help='GAT of our')
...
def main():
    ...
    if args.continue_train:
        ...
        # Build Model
        if args.gat_our:
            model = EE_GAT_ours(args, dep_tag_vocab['len'], pos_tag_vocab['len'])  # R-GAT with reshaped tree
        else:
            model = EE_GAT_only(args, dep_tag_vocab['len'], pos_tag_vocab['len'])
